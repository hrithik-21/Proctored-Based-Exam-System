...
document.getElementById("exit").onclick = sendinfo;
...
prev_btn.onclick = ()=>{
    if(que_count <= questions.length - 1 && que_count!=0){ //if question count is less than equal to total question length
...
function optionSelected(answer){
    ...
    if(userAns == correcAns){ //if user selected option is equal to array's correct answer
        ...
        arr[que_numb] = 0;
        answer.classList.add("incorrect"); //adding green color to correct selected option
